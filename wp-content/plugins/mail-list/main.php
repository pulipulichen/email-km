...
require_once('includes/menu_list.php');//list of emails with pagination
...
function mail_list_menu() {
	...
	add_submenu_page('mlmenu', $form_name.' - List', 'List', 'manage_options', 'dc_ml_menu_list', 'dc_ml_menu_list');
