        ...
        foreach ($categories as $category) {
            ...
            if (!empty($category->cat_name) && !$isExcluded) {
                ...
                if ($hasChild) {
                    ...
                    $childLink .= '<span class="jcl_symbol compact ui icon teal button" style="padding:2px;">';
                ...
                $html .= '<li class="jcl_category item ' . $hasChildClass . '" ' . $styleAttribute . ' >';
                $html .= $instance['layout'] === 'right' ? $categoryLink . $childLink : $childLink . $categoryLink;

                if ($hasChild)
                    $html .= '<ul style="padding:0;list-style: square;" class=>' . $child_html . '</ul>';
