...
quick_chat.smilies[j]+'" title="'+j+'"></div>',f=f.replace(RegExp(quick_chat.preg_quote(j),"g"),g);d='<div class="quick-chat-history-message-alias-container '+d+'"><div class="quick-chat-history-header">';0==quick_chat.user_status&&(d+='<div class="quick-chat-history-links">');0==quick_chat.user_status&&!1==c&&(d+='<input class="quick-chat-to-delete-boxes" type="checkbox" name="quick-chat-to-delete[]" value="'+a.id+'" />');0==quick_chat.user_status&&(d+="</div>");1==b&&!1!=a.avatar&&(d+=quick_chat.stripslashes(a.avatar));d+='<div class="quick-chat-history-alias">';d=e==quick_chat.user_name||!0==c||1==quick_chat.no_participation?d+e:d+('<a href="" title="'+quick_chat.i18n.reply_to_s.replace("%s",e)+'">'+e+"</a>");d=d+"</div>"+('<div class="quick-chat-history-timestring">bbbb'+
a.timestring+'</div></div><div class="quick-chat-history-message">'+f+"</div>");return d+="</div>"},check_username:function(a,b,c){"undefined"!=typeof quick_chat.data[a].username_timeout&&clearTimeout(quick_chat.data[a].username_timeout);
